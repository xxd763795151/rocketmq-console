 ...
 *
 * @author xuxd
 * @date 2021-04-15 10:42:43
 * @description rocketmq-console-ng
 * <p>
 * {@link org.apache.rocketmq.console.model.request.ApplyTopicRequest}
 **/
@Data
public class ApplyTopicDO {
    ...
    public void merge(ApplyTopicRequest request) {
        this.username = request.getUsername();
        this.producerGroup = request.getProducerGroup();
        this.subItem = request.getSubItem();
        this.queueNum = request.getQueueNum();
