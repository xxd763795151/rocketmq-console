...
public interface TopicService {
    TopicList fetchAllTopicList(boolean skipSysProcess, User user);
    ...
    Map<String, Object> selectTopicListWithItem(boolean skipSysProcess, User user);

    Map<String, Object> sendStats(String topic);
}
