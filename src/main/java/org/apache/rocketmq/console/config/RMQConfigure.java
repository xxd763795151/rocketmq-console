...
public class RMQConfigure {
    ...
    @Autowired
    private MessageTraceNode traceNode;
    ...
    public MessageTraceNode getTraceNode() {
        return traceNode;
    }

    public void setTraceNode(MessageTraceNode traceNode) {
    ...
    @Configuration
    @ConfigurationProperties(prefix = "message.trace.store.node")
    public static class MessageTraceNode {
