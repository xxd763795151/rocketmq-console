        ...
        function ($rootScope, $location, $cookies, $http, $window, Notification) {
            ...
            $http({
                ...
                if (resp && resp.status == 0) {
                    $rootScope.show = (resp.role == 1);
                } else {
                    console.log("error, login_user: " + resp);
                }
            });
...
app.config(['$routeProvider', '$httpProvider', '$cookiesProvider', 'getDictNameProvider', '$sceProvider', '$translateProvider', '$mdThemingProvider',
    function ($routeProvider, $httpProvider, $cookiesProvider, getDictNameProvider, $sceProvider, $translateProvider, $mdThemingProvider) {
        ...
        $routeProvider.when('/', {
            ...
            templateUrl: 'view/pages/userManager.html',
            controller: 'userController'
        }).when('/acl', {
            templateUrl: 'view/pages/acl.html',
            controller: 'aclController'
        }).when('/accountOperationRecord', {
            templateUrl: 'view/pages/account-operation-record.html',
            controller: 'accountOperationRecordController'
        }).when('/resourcesApplication', {
            templateUrl: 'view/pages/resources-application.html',
            controller: 'resourcesApplicationController'
        }).when('/subItemInfo', {
            templateUrl: 'view/pages/sub-item-info.html',
            controller: 'subItemInfoController'
        }).when('/backupMessage', {
            templateUrl: 'view/pages/backupMessage.html',
            controller: 'backupMessageController'
        }).when('/404', {
